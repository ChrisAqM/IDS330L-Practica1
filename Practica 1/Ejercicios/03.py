...
# 03. Implemente una función de activación del tipo sigmoide (pg. 29), llámela `sigmoid_function` 
#   y genere una nueva instancia del perceptrón utilizandola como función de activación.

# Perceptron input size:
input_size = 5

# Instantiating the perceptron:
perceptron = Neuron(num_inputs=input_size, activation_function=sigmoid_function)
